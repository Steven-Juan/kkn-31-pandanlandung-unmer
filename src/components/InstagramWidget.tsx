...
const posts: Post[] = [
  {
    image: assets.post_ig_day18,
    caption:
      "Kunjungan lanjutan tim LPPM ke Sumber Kucur untuk melakukan penilaian langsung terhadap hasil dan perkembangan kegiatan yang telah dilaksanakan di lokasi.",
    link: "https://www.instagram.com/p/DUkveGEkpUH/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==",
  },
  {
    image: assets.post_ig_day17,
    caption:
      "Kunjungan tim LPPM ke lokasi Sumber Kucur untuk melihat langsung perkembangan program konservasi sumber air serta mengecek progres kegiatan yang sudah berjalan.",
    link: "https://www.instagram.com/p/DUkrwC2Ekuy/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==",
  },
  {
    image: assets.post_ig_day16,
    caption:
      "Proses pemasangan gapura di area Sumber Kucur untuk menandai lokasi serta mendukung penataan kawasan sumber air.",
    link: "https://www.instagram.com/p/DUklvm3kqWO/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==",
  },
];
      ...
      <div className="flex flex-col md:flex-row items-center justify-between py-6 px-6 md:px-10 bg-[#1a1a1a] gap-8 md:gap-10">
        ...
        >
          ...
          <div className="flex flex-col">
            ...
            <p className="text-neutral-400 text-[13px]">@kkn31.pandanlandung</p>
          </div>
        </a>
        ...
        <div className="flex items-center gap-10">
          <div className="flex gap-4 md:gap-8 text-[13px] md:text-[14px]">
            ...
            <div className="text-center">
              <span className="font-bold block">80</span>
              <span className="text-[12px] text-neutral-400 tracking-wider">
                Followers
              </span>
            </div>
            <div className="text-center">
              <span className="font-bold block">66</span>
