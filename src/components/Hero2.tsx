...
const Hero2: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen bg-[#3E2522] overflow-hidden">
      {/* BACKGROUND SVG */}
      <svg
      ...
      >
        <path stroke="#8C6E63" strokeOpacity={0.6} d="M-15.227 702.342H1439.7" />
        <circle cx="711.819" cy="372.562" r="308.334" stroke="#8C6E63" strokeOpacity={0.6} />
        <circle cx="16.942" cy="20.834" r="308.334" stroke="#8C6E63" strokeOpacity={0.6} />
        <path stroke="#8C6E63" strokeOpacity={0.6} d="M-15.227 573.66H1439.7M-15.227 164.029H1439.7" />
        <circle cx="782.595" cy="411.166" r="308.334" stroke="#8C6E63" strokeOpacity={0.6} />
      </svg>

      {/* NAVBAR */}
      <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 text-[#FFF2DF] backdrop-blur z-50">
        ...
        <button className="hidden md:block bg-[#FFF2DF] text-[#3E2522] px-6 py-2.5 rounded-full hover:bg-[#FFEOB2] transition">
          Contact us
        </button>
      ...
      <section className="flex flex-col md:flex-row items-center justify-between mt-20 px-4 md:px-16 lg:px-24 xl:px-32 pb-20 gap-16">
        <div className="text-center md:text-left">
          ...
          <h1 className="text-5xl md:text-6xl leading-tight font-medium text-[#FFF2DF] max-w-xl">
            Intelligent AI tools built to help.
          </h1>

          <p className="text-sm text-[#FFEOB2] max-w-lg mt-3">
