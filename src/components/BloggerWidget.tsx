...
const BLOGGER_URL = "https://kkn31pandanlandungunmer2026.blogspot.com/";
        ...
        >
          ...
          <div className="flex flex-col">
            <h3 className="font-bold text-[18px] tracking-tight leading-tight group-hover/profile:underline">
              Berita Seputar Kegiatan KKN 31 Pandanlandung Unmer 2026
            </h3>
            <p className="text-neutral-400 text-[13px] mt-1">
              Blog ini berisi seputar kegiatan selama KKN kelompok 31 dari
              Universitas Merdeka Malang di desa Pandanlandung tahun 2026
            </p>
          </div>
        </a>
