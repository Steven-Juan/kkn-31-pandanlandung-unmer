                        ...
                        {features.map((feature) => (
                            <div key={feature.name} className="relative pl-16">
                                <dt className="text-base/7 font-semibold text-white">
                                    <div className="absolute top-0 left-0 flex size-10 items-center justify-center rounded-lg bg-[#FFF2DF]">
                                        <feature.icon aria-hidden="true" className="size-6 text-[#3E2522]" />
                                    </div>
                                    {feature.name}
                                </dt>
